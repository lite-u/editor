...
exports.updateSelectionBox = exports.updateScrollBars = void 0;
exports.initViewportDom = initViewportDom;
exports.updateCursor = updateCursor;
const createWith = (tagName, role, id) => {
...
const updateScrollBars = (scrollBarX, scrollBarY) => {
...
const updateSelectionBox = (selectionBox, { x, y, height, width }, show = true) => {
    selectionBox.style.transform = `translate(${x}px, ${y}px)`;
    selectionBox.style.width = width + 'px';
    selectionBox.style.height = height + 'px';
    selectionBox.style.display = show ? 'block' : 'none';
};
exports.updateSelectionBox = updateSelectionBox;
