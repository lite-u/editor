...
const createFrame = (p, id) => {
    ...
    x = width / 2;
    y = height / 2;
    return new rectangle_ts_1.default({
        id,
        x,
        y,
        width,
...
* */
const fitRectToViewport = (rect, viewport, paddingScale = 0.02) => {
