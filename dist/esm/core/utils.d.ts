...
export declare const setFloatOnProps: <T extends RenderPropsList, K extends "enableLine" | "id" | "lineColor" | "lineWidth" | "opacity" | "layer" | "rotation" | "shadow" | "x" | "y" | "enableGradient" | "gradient" | "enableFill" | "fillColor" | "dashLine" | "type">(obj: T, keys: K[]) => void;
