...
import { applyResize } from '../../services/tool/events/helper.js';
...
const rectangleTool = {
    ...
    finish(e) {
        ...
        if (leftMouseClick) {
            const { draggingModules, manipulationStatus, elementManager, _selectingModules, selectedShadow, viewport, interaction, } = this;
