...
function transform({ downPoint, movePoint, elementOrigin, rotation, handleName, scale, dpr, altKey = false, shiftKey = false, }) {
    const { width: initialWidth, height: initialHeight, cx: initialCX, cy: initialCY, } = elementOrigin;
