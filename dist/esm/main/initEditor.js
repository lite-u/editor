...
export function initEditor() {
    ...
    on('render-modules', () => {
        resetCanvas(this.viewport.mainCTX, this.viewport.scale, this.viewport.offset);
        this.renderModules();
    });
    on('render-selection', () => {
        resetCanvas(this.viewport.selectionCTX, this.viewport.scale, this.viewport.offset);
