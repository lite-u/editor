...
export function initViewportDom(id) {
...
export const updateScrollBars = (scrollBarX, scrollBarY) => {
...
export const updateSelectionBox = (selectionBox, { x, y, height, width }, show = true) => {
    selectionBox.style.transform = `translate(${x}px, ${y}px)`;
    selectionBox.style.width = width + 'px';
    selectionBox.style.height = height + 'px';
    selectionBox.style.display = show ? 'block' : 'none';
};
export function updateCursor(type, position, angle) {
