...
class Ellipse extends shape_ts_1.default {
    ...
    getBoundingRect() {
        ...
        return (0, utils_ts_1.generateBoundingRectFromRotatedRect)({
            x: cx - r1,
            y: cy - r2,
            width: r1 * 2,
            height: r2 * 2,
    ...
    getSelectedBoxModule(lineWidth, lineColor) {
        ...
        return new rectangle_ts_1.default(rectProp);
    }
...
Ellipse.applyResizeTransform = ({ downPoint, movePoint, moduleOrigin, rotation, handleName, scale, dpr, altKey = false, shiftKey = false, }) => {
    ...
    const t = (0, lib_ts_1.getResizeTransform)(handleName, altKey);
