...
exports.applyRotating = applyRotating;
exports.isPointNearStroke = isPointNearStroke;
exports.isPointNearStroke2 = isPointNearStroke2;
function applyRotating(shiftKey) {
...
function isPointNearStroke(ctx, path, point, tolerance = 1, step = 1) {
...
function isPointNearStroke2(ctx, path, point, tolerance = 5, baseLineWidth) {
    ctx.save();
