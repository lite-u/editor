...
exports.getAnchorsByResizeDirection = exports.getAnchorsByBoundingRect = exports.getBoundingRectFromBoundingRects = void 0;
const getBoundingRectFromBoundingRects = (list) => {
    if (list.length === 0) {
        return {
            x: 0,
            y: 0,
...
exports.getBoundingRectFromBoundingRects = getBoundingRectFromBoundingRects;
const getAnchorsByBoundingRect = (rect) => {
...
exports.getAnchorsByBoundingRect = getAnchorsByBoundingRect;
const getAnchorsByResizeDirection = (r, d) => {
    var _a;
    const map = {
    ...
    const [anchor, opposite] = (_a = map[d]) !== null && _a !== void 0 ? _a : [{ x: r.cx, y: r.cy }, { x: r.cx, y: r.cy }];
    return { anchor, opposite };
};
exports.getAnchorsByResizeDirection = getAnchorsByResizeDirection;
